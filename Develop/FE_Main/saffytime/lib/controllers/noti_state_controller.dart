...
import 'package:saffytime/models/noti_custom_state.dart';
import 'package:saffytime/models/noti_default_state.dart';
...
// 개인 알림 추가
  void addCustomState(String title, List<bool> repeatDate, DateTime time) {
    bool state = true;
    NotiCustomState custom = NotiCustomState(
        title: title, repeatDate: repeatDate, time: time, isOn: state);
