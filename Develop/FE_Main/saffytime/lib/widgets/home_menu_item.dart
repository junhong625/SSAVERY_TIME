...
class HMIW extends StatefulWidget {
  ...
  const HMIW({Key? key,
    ...
    required this.foodKcal}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(imgUrl, fit: BoxFit.fill, // option1
              ...
              Padding(padding: EdgeInsets.only(left: 10, top: 5),
                child: Column(
                  ...
                  children: [
                    // option2-1
                    Text(mainMenu, style: TextStyle(fontWeight: FontWeight.w900,
                        fontSize: 16)),
                    // option2-2
                    Text(subMenuA,  style: TextStyle(fontWeight: FontWeight.w900,
                        fontSize: 12, color: Color(0xff73777F))),
                    // option2-3
                    Text(subMenuB+' ...',  style: TextStyle(fontWeight: FontWeight.w900,
                        fontSize: 12, color: Color(0xff73777F))),
                    SizedBox(height: 5,),
                    // option 3
                    Text(foodKcal.toString() + 'kcal',  style: TextStyle(fontWeight: FontWeight.w900,
                      fontSize: 12,)),
                  ],
                ),
              ),
