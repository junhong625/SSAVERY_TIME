...
import 'package:ssafytime/utils/api_client.dart';
import 'package:ssafytime/utils/request_config.dart';
...
class Signaling {
  ...
  Future<dynamic> createWebRtcSession({String? sessionId}) {
    ...
    return ApiClient()
        .request<Map<String, dynamic>>(Config(
            uri: Uri.parse('https://$_url/openvidu/api/sessions'),
            headers: headersMap,
  ...
  Future<dynamic> createWebRtcToken(
    ...
    return ApiClient()
        .request<Map<String, dynamic>>(Config(
            uri: Uri.parse('https://$_url/openvidu/api/tokens'),
            headers: headersMap,
            body: RequestBody.json(bodyMap),
            method: RequestMethod.post,
            responseType: ResponseBody.json()))
